...
Revision ID: 2b69edfe3018
Revises: 4ca9a08f93f0
Create Date: 2022-11-27 17:21:34.648229
...
revision = '2b69edfe3018'
down_revision = '4ca9a08f93f0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(None, 'lk_vai_tro_nhan_vien', ['vai_tro_id'])
    ...
    op.alter_column('vai_tro', 'ten',
               ...
               nullable=False)
    op.create_unique_constraint(None, 'vai_tro', ['id'])
...
def downgrade():
    ...
    op.drop_constraint(None, 'lk_vai_tro_nhan_vien', type_='foreignkey')
    op.drop_constraint(None, 'lk_vai_tro_nhan_vien', type_='unique')
    # ### end Alembic commands ###
