...
Revision ID: 7725a3b41642
Revises: 3defa0127e24
Create Date: 2022-08-24 10:19:38.586377
...
revision = '7725a3b41642'
down_revision = '3defa0127e24'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('danhmuc_vi_tri_hanh_nghe', sa.Column('loai', sa.String(), nullable=True))
