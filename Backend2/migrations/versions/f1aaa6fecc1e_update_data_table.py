...
Revision ID: f1aaa6fecc1e
Revises: d93e8833bbc8
Create Date: 2022-06-23 15:19:51.501556
...
revision = 'f1aaa6fecc1e'
down_revision = 'd93e8833bbc8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('chung_tu_dinh_kem', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
