...
Revision ID: 4087ed5fb73c
Revises: d236b94dc93b
Create Date: 2022-06-07 14:25:36.466362
...
revision = '4087ed5fb73c'
down_revision = 'd236b94dc93b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('ngay_sinh', sa.String(), nullable=True),
    ...
    sa.Column('gio_bat_dau', sa.String(), nullable=True),
    sa.Column('co_so_kinh_doanh_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('dia_chi', sa.String(), nullable=True),
    sa.Column('phut_bat_dau', sa.String(), nullable=True),
    sa.Column('gio_ket_thuc', sa.String(), nullable=True),
    sa.Column('ngay_bat_dau', sa.String(), nullable=True),
    sa.Column('ngay_ket_thuc', sa.String(), nullable=True),
    ...
    sa.Column('ngay_nop_ho_so', sa.String(), nullable=True),
    ...
    sa.Column('ngay_quyet_dinh', sa.String(), nullable=True),
    sa.Column('loai_ma_chung_chi_gps', sa.String(), nullable=True),
    sa.Column('so_chung_nhan_gps', sa.String(), nullable=True),
    sa.Column('ngay_cap_gps', sa.String(), nullable=True),
    sa.Column('ngay_het_han_gps', sa.String(), nullable=True),
    ...
    sa.Column('thoi_gian_cap_nhat', sa.String(), nullable=True),
