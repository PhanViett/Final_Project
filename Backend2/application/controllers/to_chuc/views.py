...
from application.controllers.to_chuc.resources.noi_dung_thuc_hanh import NoiDungThucHanhResource,NoiDungThucHanhById,NoiDungThucHanhGetList
...
api.add_resource(NoiDungThucHanhResource, "/noi_dung_thuc_hanh_add", endpoint="Resource")
api.add_resource(NoiDungThucHanhById, "/noi_dung_thuc_hanh_by_id/<id>", endpoint="ById")
